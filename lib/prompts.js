...
LOCATION (ZIP): ${project.zip_code || "not provided"}
...
export const TYPE_PROMPTS = {
  ...
  materials: `Produce an itemized MATERIALS LIST as a Markdown table with columns: Item, Specification (size/grade/type), Quantity, Est. Unit Price (USD), Est. Total. Group by category. Include 10% waste factor on lumber/tile/etc. End with grand total range and money-saving substitutions.`,
  ...
  estimate: `Produce a COST ESTIMATE comparing: (1) full DIY, (2) hybrid (DIY + hired trades for the hard parts), (3) fully contracted. For each: line-item breakdown, low/high range, and total. Use realistic current US pricing adjusted for the ZIP code region. End with a recommendation given the stated budget and skill level.`,
  ...
  permits: `Produce a PERMITS & CODE CHECKLIST for this project type and location: which permits are likely required (building/electrical/plumbing/mechanical), typical cost and timeline, which work legally requires licensed trades in most US jurisdictions, key code requirements (spans, spacing, clearances, GFCI, egress, etc., as relevant), inspection points and what inspectors look for, and consequences of skipping permits. Recommend confirming with the local building department and include how to find it for the given ZIP.`,
  ...
  budget: `Generate the initial line items for a BUDGET TRACKER. Return ONLY valid JSON: {"items":[{"name":"...","category":"Materials|Tools|Rentals|Labor|Permits|Other","planned":123}]}. 10-25 items covering everything this project will cost, with realistic planned amounts in USD. No markdown, no commentary.`,
